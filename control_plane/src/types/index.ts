...
// ============================================================================
// REPAIR SELECTION COMPONENT TYPES
// ============================================================================
...
// ============================================================================
// RECONCILIATION COMPONENT TYPES
// ============================================================================
...
export class IncidentProcessingError extends Error {
  constructor(
    ...
    public escalation_required: boolean = false,
    message?: string
  ) {
    super(message || code);
...
export class RetryableError extends IncidentProcessingError {
...
export class EscalationError extends IncidentProcessingError {
  constructor(code: string, component: string, message?: string) {
